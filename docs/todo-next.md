...
- Sound audio math helpers for effective volume, MIDI frequency, clamping, footstep timing, and distortion curves were extracted into `src/logic/sound-audio-utils.mjs`, with focused checks for gain curves, MIDI octaves, footstep intervals, swing offsets, and curve shape.
