...
- Event/rest/merchant/trial reward resolution now shares `src/logic/room-reward-resolution.mjs` message finalization, with focused checks for theme-chain detail appending and UI refresh callbacks.
