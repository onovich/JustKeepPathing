...
- Sound audio math helpers for effective volume, MIDI frequency, clamping, and distortion curves were extracted into `src/logic/sound-audio-utils.mjs`, with focused checks for gain curves, MIDI octaves, and curve shape.
