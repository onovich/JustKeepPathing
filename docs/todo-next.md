...
- Hidden-room diversion scoring, interaction-resolution, and pickup pending-state helpers were extracted into `src/logic/hidden-room-routing.mjs` and `src/logic/hidden-room-resolution.mjs`, with focused check scripts.
