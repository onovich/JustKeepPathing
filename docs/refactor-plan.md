...
- Move sound editor UI logic into `src/view/editors/sound-editor.mjs`. (Started with `editors/sound-editor-chrome.mjs` for transport command chrome, `editors/editor-dom.mjs` refs, shared `editors/editor-log.mjs` logging, and `editors/sound-editor-controls.mjs` control markup.)
