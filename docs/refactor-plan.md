...
- Keep hidden-room route scoring, small resolution predicates, reward calculations/plans, merchant purchase decisions, sound audio/timing/BGM step-plan/config/storage helpers, and theme-chain formulas in `src/logic/` modules. (Started: `hidden-room-routing.mjs`, `hidden-room-resolution.mjs`, `room-reward-calculations.mjs`, `room-reward-plans.mjs`, `sound-audio-utils.mjs`, `sound-config.mjs`, `sound-storage.mjs`, `theme-chain-bonuses.mjs`.)
